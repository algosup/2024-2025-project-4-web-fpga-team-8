...
module FULLLUT (
    ...
    //Interconnect
    fpga_interconnect \routing_segment_I1_output_0_0_to_lut_O1_input_0_1  (
        .datain(\I1_output_0_0 ),
        .dataout(\lut_O1_input_0_1 )
    );

    fpga_interconnect \routing_segment_I2_output_0_0_to_lut_O1_input_0_0  (
        .datain(\I2_output_0_0 ),
        .dataout(\lut_O1_input_0_0 )
    );

    fpga_interconnect \routing_segment_I3_output_0_0_to_lut_O1_input_0_2  (
        .datain(\I3_output_0_0 ),
        .dataout(\lut_O1_input_0_2 )
    );

    fpga_interconnect \routing_segment_I4_output_0_0_to_lut_O1_input_0_4  (
